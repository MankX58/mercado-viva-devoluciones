...
import { CheckCircle2, Loader2, PackageX, RotateCcw } from "lucide-react";
...
export default function AdminRefundsPage() {
  ...
  async function loadRefunds() {
    ...
    try {
      ...
      if (!res.ok) throw new Error("No se pudieron cargar los reembolsos");
  ...
  async function handleRevert(id) {
    ...
    setError(null);
    try {
      const res = await fetch(`/api/refunds/${id}/revert`, { method: "POST" });
      if (!res.ok) throw new Error("No se pudo revertir el reembolso");
